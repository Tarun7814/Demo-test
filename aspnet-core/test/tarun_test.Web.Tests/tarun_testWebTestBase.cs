...
{
    public abstract class tarun_testWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static tarun_testWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(tarun_testWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<tarun_testDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<tarun_testDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<tarun_testDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<tarun_testDbContext, Task<T>> func)
        {
            T result;
