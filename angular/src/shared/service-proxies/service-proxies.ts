...
export class CountriesServiceProxy {
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<CountriesDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<CountriesDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CountriesDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<CountriesDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        return _observableOf<CountriesDto>(null as any);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CountriesDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<CountriesDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CountriesDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<CountriesDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CountriesDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CountriesDtoPagedResultDto>(null as any);
    }
     ...
     * @return Success
     */
    create(body: CountriesDto | undefined): Observable<CountriesDto> {
    ...
    protected processCreate(response: HttpResponseBase): Observable<CountriesDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update(body: CountriesDto | undefined): Observable<CountriesDto> {
    ...
    protected processUpdate(response: HttpResponseBase): Observable<CountriesDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class StatesServiceProxy {
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<StatesDto> {
        let url_ = this.baseUrl + "/api/services/app/States/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<StatesDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<StatesDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<StatesDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = StatesDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<StatesDto>(null as any);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<StatesDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<StatesDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<StatesDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<StatesDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = StatesDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<StatesDtoPagedResultDto>(null as any);
    }
     ...
     * @return Success
     */
    create(body: StatesDto | undefined): Observable<StatesDto> {
        let url_ = this.baseUrl + "/api/services/app/States/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<StatesDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update(body: StatesDto | undefined): Observable<StatesDto> {
        let url_ = this.baseUrl + "/api/services/app/States/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<StatesDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class CountriesDtoPagedResultDto implements ICountriesDtoPagedResultDto {
    items: CountriesDto[] | undefined;
    totalCount: number;

    constructor(data?: ICountriesDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(CountriesDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): CountriesDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new CountriesDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): CountriesDtoPagedResultDto {
        const json = this.toJSON();
        let result = new CountriesDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface ICountriesDtoPagedResultDto {
    items: CountriesDto[] | undefined;
    totalCount: number;
}
...
export class StatesDto implements IStatesDto {
    id: string;
    creationTime: moment.Moment;
    creatorUserId: number | undefined;
    lastModificationTime: moment.Moment | undefined;
    ...
    static fromJS(data: any): StatesDto {
        data = typeof data === 'object' ? data : {};
        let result = new StatesDto();
        result.init(data);
        return result;
    }
...
export class StatesDtoPagedResultDto implements IStatesDtoPagedResultDto {
    items: StatesDto[] | undefined;
    totalCount: number;

    constructor(data?: IStatesDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(StatesDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): StatesDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new StatesDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IStatesDtoPagedResultDto {
    items: StatesDto[] | undefined;
    totalCount: number;
}
